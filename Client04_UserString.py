...
class Client(tk.Frame):
    ...
    def CreateSocket(self):
        try:
            ...
            self.sock.settimeout(10)  # Related to broken socket judgement
    ...
    def button_1_enter_handler(self, event):
        print '[B01]Mouse Enter', event.time, event.type
    ...
    def button_5_handler(self):
        try:
            ...
            if peername:
                ...
                print '[B05]Chat Exists', peername
        except Exception, emsg:
            print '[450]B5 ', str(emsg)
